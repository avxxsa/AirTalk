      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-center">
          <div>
            ...
            <a
              href="/about"
              className="inline-block px-8 py-3 border border-[#E5989B] text-[#E5989B] text-sm uppercase font-medium rounded hover:bg-[#E5989B]/10 transition-all hover:-translate-y-1 no-underline"
            >
              Learn More
            </a>
          </div>
